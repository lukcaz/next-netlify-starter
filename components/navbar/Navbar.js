...
const Navbar = () => {
  ...
  return (
    <div className="sm:hidden bg-green-300 rounded-lg w-full px-4">
      ...
      <div
        className={`fixed w-full h-full top-24 right-0 bg-gray-200 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-60 rounded-tl-2xl opacity-98 z-10 transform ease-in-out duration-300 ${
